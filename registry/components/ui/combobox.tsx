...
function ComboboxSeparator(props: BaseCombobox.Separator.Props) {
  return <BaseCombobox.Separator className="h-px w-full bg-gray-200 dark:bg-gray-800" {...props} />;
}

function ComboboxChips({ className, ...props }: BaseCombobox.Chips.Props) {
  return <BaseCombobox.Chips className={cn("flex flex-wrap gap-1", className)} {...props} />;
}
