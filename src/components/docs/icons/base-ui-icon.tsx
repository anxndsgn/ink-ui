export function BaseUIIcon({ size = 20 }: { size?: number }) {
  const height = size;
  const width = (17 / 24) * size; // maintain aspect ratio
  return (
    <svg width={width} height={height} viewBox="0 0 17 24" fill="currentColor" aria-label="Base UI">
